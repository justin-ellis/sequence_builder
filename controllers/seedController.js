...
var asanas = [ { 
  ...
  // { 
    ...
    translation: [ 'ānanda = happy', 'bāla = child' ],
  ...
  { 
    ...
    // translation: [ 'baddha = bound', 'koṇa = angle' ],
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/vkmx4s3x37yi3wn/upward_bow.png?dl=0',
    pose_name: 'Bow Pose',
    sanskrit_name: 'Dhanurāsana',
    translation: [ 'dhanur = bow' ],
  ...
  { 
    ...
    translation: [ 'ardha = half', 'dhanu = bow' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/freold8f0tiyqez/bridge.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/xjiexyz4g3ehgnn/wheel_leg_up.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/4tzau97vmnq4bs7/cat.png?dl=0',
    pose_name: 'Cat Pose',
    sanskrit_name: 'Marjaryāsana',
    translation: [ 'marjarya = cat' ],
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/spd0h8rfdf0fpsk/chair_squat.png?dl=0',
    pose_name: 'Chair Pose',
    sanskrit_name: 'Utkaṭāsana',
    translation: [ 'utkaṭa = fierce' ],
    category: 'Standing / Balancing',
    difficulty: 'Beginner',
  ...
  { 
    ...
    translation: [ 'parivṛtta = revolved', 'utkaṭa = fierce' ],
  ...
  //   translation: [ 'svarga = heaven', 'dvija = twice born' ],
  //   category: 'Standing / Balancing',
  //   difficulty: 'Expert',
  //   description:
  //    [ 'From ',
  ...
  { 
    ...
    translation: [ 'utthita = extended', 'bala = child' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/hwxzr33idiqu1rb/balasana.png?dl=0',
    pose_name: 'Child\'s Pose',
    sanskrit_name: 'Balāsana',
    translation: [ 'bala = child' ],
    category: 'Prone / Forward Bend',
    difficulty: 'Beginner',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/0ic3dgx7m2397zw/supine_urdhva_hasta.png?dl=0',
    pose_name: 'Corpse Pose',
    sanskrit_name: 'Śavāsana',
    translation: [ 'śava = corpse' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/5aw5fk4mxc88j7j/supine_leg_lift.png?dl=0',
    pose_name: 'Rejuvenation Pose',
    sanskrit_name: 'Supta Daṇḍāsana',
    translation: [ 'supta = supine', 'daṇḍa = staff' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/tlx5fjgk98hdg0q/bikram_half_moon.png?dl=0',
    pose_name: 'Crescent Moon Pose',
    sanskrit_name: 'Ashta Chandrāsana',
    translation: [ 'ashta = side', 'chandra = moon' ],
  ...
  //   translation: [ 'pārśva = side', 'baka = crane' ],
  //   alt_name: 'Side Crane',
  //   category: 'Arm Balance+Inversion / Twist',
  //   difficulty: 'Expert',
  //   description:
  //    [ 'Start from ',
  //      'crow pose',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/feqfg81qm6tq5l9/ear_pressure_bind.png?dl=0',
    pose_name: 'Deaf Man\'s Pose',
    sanskrit_name: 'Karṇapīḍāsana',
    translation: [ 'karṇa = ear', 'pīḍa = pressure' ],
    alt_name: 'Ear Pressure',
    category: 'Arm Balance+Inversion / Forward Bend',
    difficulty: 'Expert',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/lkpnd4x6bu0ahm9/cow.png?dl=0',
    pose_name: 'Cow Pose',
    sanskrit_name: 'Bitilāsana',
    translation: [ 'bitil = cow' ],
    alt_name:  'Dog',
    category: 'Arm+Leg Support / Backbend',
    difficulty: 'Beginner',
    description:
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/7z7tjmh04609z9j/downward_dog_step.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/0a83q6hn5bscgnr/sukhasana.png?dl=0',
    pose_name: 'Easy Pose',
    sanskrit_name: 'Sukhāsana',
    translation: [ 'sukha = pleasure' ],
    category: 'Seated / Neutral',
    difficulty: 'Beginner',
  ...
  //   translation: [ 'aṣṭā = eight', 'vakra = bent, curved' ],
  //   category: 'Arm Balance+Inversion / Balancing',
  //   difficulty: 'Expert',
  //   description:
  //    [ 'Begin in ',
  ...
  //   translation: [ 'pīñcha = feather', 'mayūra = peacock' ],
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/i2qsgfw8bap2qka/square.png?dl=0',
    pose_name: 'Fire Log Pose',
    sanskrit_name: 'Agnistambhāsana',
    translation: [ 'agni = fire', 'stambha = statue' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/bx3cz4878shzreg/tittibasana.png?dl=0',
    pose_name: 'Firefly Pose',
    sanskrit_name: 'Tittibhāsana',
    translation: [ 'tittibha = firefly' ],
    category: 'Arm Balance+Inversion / Balancing',
    difficulty: 'Expert',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/m4nle28t81fvm42/uttana_padasana.png?dl=0',
    pose_name: 'Fish Pose',
    sanskrit_name: 'Matsyāsana',
    translation: [ 'matsya = fish' ],
    category: 'Supine / Backbend',
    difficulty: 'Intermediate',
  ...
  //    [ 'Starting from ',
  //      'downward_dog',
  //      ' , bend both elbows to a 90-degree angle then cross one leg over the opposite elbow and extend the leg.  The other leg is extended back either balanced on the toes or suspended in flight with active toes.  The body is parallel to the earth.  The gaze is to the front.' ],
  //   benefits: 'Strengthens arms, legs, core and wrists.  Improves balance.' },
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/odm43grq4uuv908/forward_fold.png?dl=0',
    pose_name: 'Standing Forward Bend Pose',
    sanskrit_name: 'Uttānāsana',
    translation: [ 'uttāna = stretch out' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/jk0bu2oj6sarpli/forward_fold_c_bind.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/3mqfvlhzszyt4cf/half_fold_arms.png?dl=0',
    pose_name: 'Halfway Lift Pose',
    sanskrit_name: 'Ardha Uttānāsana',
    translation: [ 'ardha = half', 'uttāna = stretch out' ],
    category: 'Standing / Forward Bend',
    difficulty: 'Beginner',
    ...
    benefits: 'Calms the brain and helps relieve stress and mild depression.  Stimulates the liver and kidneys.  Stretches the hamstrings, calves, and hips.  Strengthens the thighs and knees.  Improves digestion.  Helps relieve the symptoms of menopause.  Reduces fatigue and anxiety.  Relieves headache and insomnia.' },
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/ijqe9007kdqwje0/chaturanga.png?dl=0',
  ...
  //   translation: [ 'mālā = garland or necklace' ],
  //   category: 'Seated / Balancing',
  //   difficulty: 'Beginner',
  ...
  // { 
    ...
    translation: [ 'pāda = foot or leg', 'hasta = hand' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/639t6k0wxlpnhdq/half_moon.png?dl=0',
    pose_name: 'Half Moon Pose',
    sanskrit_name: 'Ardha Chandrāsana',
    translation: [ 'ardha = half', 'chandra = moon' ],
    category: 'Standing / Balancing',
    difficulty: 'Intermediate',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/mkjg8i2yqc8hgy6/scorpion_handstand.png?dl=0',
    pose_name: 'Scorpion Handstand Pose',
    sanskrit_name: 'Vṛśchikāsana II',
    translation: [ 'vṛśchika = scorpion' ],
    category: 'Arm Balance+Inversion / Balancing',
    difficulty: 'Expert',
    description:
     [ 'From ',
  ...
  { 
    ...
    benefits: 'Calms the brain and helps relieve stress and mild depression.  Stimulates the pituitary and pineal glands.  Strengthens the arms, legs, and spine.  Strengthens the lungs.  Tones the abdominal organs.  Improves digestion.  Helps relieve the symptoms of menopause.  Therapeutic for asthma, infertility, insomnia and sinusitis.' },
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/18j8jylahhz6kop/vajrasana.png?dl=0',
    pose_name: 'Hero Pose',
    sanskrit_name: 'Vīrāsana',
    translation: [ 'vīra = hero' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/0666k89t2ne172q/supine_hero.png?dl=0',
    pose_name: 'Supine Hero Pose',
    sanskrit_name: 'Supta Vīrāsana',
    translation: [ 'supta = supine', 'vīra = hero' ],
    category: 'Supine / Backbend',
    difficulty: 'Intermediate',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/606qn2h1yamf3ye/locust.png?dl=0',
    pose_name: 'Locust Pose',
    sanskrit_name: 'Śalabhāsana',
    translation: [ 'śalabha = locust' ],
    category: 'Prone / Backbend',
    difficulty: 'Intermediate',
  ...
  { 
    ...
    translation: [ 'ardha = half', 'śalabha = locust' ],
    category: 'Prone / Backbend',
    difficulty: 'Beginner',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/3xfoyime6qz98hw/dancer.png?dl=0',
    pose_name: 'Lord of the Dance Pose',
    sanskrit_name: 'Naṭarājāsana',
    translation: [ 'naṭarājā = lord of the dance' ],
    alt_name: 'Dancer\'s',
    category: 'Standing / Balancing',
    difficulty: 'Intermediate',
  ...
  { 
    ...
    translation: [ 'ardha = half', 'padma = lotus' ],
    category: 'Seated / Neutral',
    difficulty: 'Beginner',
  ...
  //   translation: [ 'marīchi = name of a sage' ],
  //   category: 'Seated / Twist',
  //   difficulty: 'Intermediate',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/bs9vf26yr22fwka/mountain.png?dl=0',
    pose_name: 'Mountain Pose',
    sanskrit_name: 'Tāḍāsana',
    translation: [ 'tāḍa = mountain' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/kw73uxekjbp59w9/urdhva_hasta_backbend.png?dl=0',
  ...
  //     ],
  //   category: 'Arm Balance+Inversion / Neutral',
  //   difficulty: 'Expert',
  //   description:
  //    [ 'Begin in ',
  //      'tree',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/sz3m1zpp39vkmnx/king_pigeon.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/szhrey9u5480ltx/plank.png?dl=0',
    ...
    benefits: 'Strengthens the arms, wrists and spine.  Tones the abdomen.' },
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/emanzaq9llsmzx0/side_plank.png?dl=0',
    pose_name: 'Side Plank Pose',
    sanskrit_name: 'Vasiṣṭhāsana',
    translation: [ 'vasiṣṭha = name of a sage' ],
    category: 'Arm+Leg Support / Balancing',
    difficulty: 'Intermediate',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/29pjwzyodjza3pg/side_plank_bind.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/il3t0t199czr1t1/purvatanasana.png?dl=0',
    pose_name: 'Upward Plank Pose',
    sanskrit_name: 'Pūrvottānāsana',
    translation: [ 'pūrva = front', 'uttānā = stretch' ],
    category: 'Arm+Leg Support / Backbend',
    difficulty: 'Intermediate',
    description:
     [ 'From ',
  ...
  { 
    ...
    translation: [ 'uttāna = stretch out', 'shisho = puppy' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/lkdf2rxl6ye1m4u/pyramid_variation.png?dl=0',
    pose_name: 'Pyramid Pose',
    sanskrit_name: 'Pārśvottānāsana',
    translation: [ 'pārśva = side', 'uttāna = stretch out' ],
    category: 'Arm+Leg Support / Forward Bend',
    difficulty: 'Intermediate',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/7zw4xpilaqscdb9/rabbit.png?dl=0',
    pose_name: 'Rabbit Pose',
    sanskrit_name: 'Sasangāsana',
    translation: [ 'sasanga = rabbit' ],
    category: 'Arm+Leg Support / Forward Bend',
    difficulty: 'Beginner',
    description:
     [ 'From ',
  ...
  //   benefits: 'Strengthens arms and wrists.  Improves focus and concentration.  Opens flexibility of lower body.' },
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/wxepzmbg5zlq4nm/scorpion_forearm.png?dl=0',
  ...
  { 
    ...
    translation: [ 'paśchima = back', 'uttāna = stretch out' ],
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/lgugvj13s0ckgvy/shoulder_stand.png?dl=0',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/ojokwfk3t8bhv55/hanumanasana.png?dl=0',
    pose_name: 'Front Splits Pose',
    sanskrit_name: 'Hanumānāsana',
    translation: [ 'hanumān = monkey deity' ],
    alt_name: 'Monkey',
    category: 'Seated / Balancing',
    difficulty: 'Expert',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/7n87zs2cakr1zrl/upavista_konasana.png?dl=0',
    pose_name: 'Side Splits Pose',
    sanskrit_name: 'Upaviṣṭha Koṇāsana',
    translation: [ 'upaviṣṭha = seated', 'koṇa = angle' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/m0fl2xb3lx5k5fe/seated_forward_fold.png?dl=0',
    pose_name: 'Staff Pose',
    sanskrit_name: 'Daṇḍāsana',
    translation: [ 'daṇḍa = staff' ],
    category: 'Seated / Neutral',
    difficulty: 'Beginner',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/330lougb3afxoo4/forearm_wheel.png?dl=0',
  ...
  { 
    ...
    translation: [ 'hasta = hand', 'pādāṅguṣṭha = big toe' ],
    category: 'Standing / Balancing',
    difficulty: 'Expert',
    description:
     [ 'From ',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/8grt8755f9d2jea/supine_pada_hasta.png?dl=0',
  ...
  //   translation: [ 'supta = supine', 'kapota = pigeon' ],
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/fz5ex9h4axyokw8/tree.png?dl=0',
    pose_name: 'Tree Pose',
    sanskrit_name: 'Vṛkṣāsana',
    translation: [ 'vṛkṣa = tree' ],
    category: 'Standing / Balancing',
    difficulty: 'Intermediate',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/9tyhx1cr8swxy4w/triangle.png?dl=0',
    pose_name: 'Triangle Pose',
    sanskrit_name: 'Trikoṇāsana',
    translation: [ 'trikoṇa = triangle' ],
    category: 'Standing / Lateral Bend',
    difficulty: 'Beginner',
  ...
  { 
    ...
    benefits: 'Calms the brain.  Stimulates the liver and kidneys.  Stretches the hamstrings, calves, and thighs.  Strengthens the thighs, knees, and ankles.  Stretches the back of the leg, the front thigh and groin.' },
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/ud46dn3174wborn/wind_relieving.png?dl=0',
    pose_name: 'Wind Removing Pose',
    sanskrit_name: 'Pavanamuktāsana',
    translation: [ 'pavana = wind', 'mukta = releasing' ],
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/mwgmu8zhhoddnzj/upward_dog.png?dl=0',
  ...
  { 
    ...
    translation: [ 'vīrabhadra = warrior' ],
    category: 'Standing / Balancing',
    difficulty: 'Beginner',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/yufpsetjwnjc24s/warrior_2.png?dl=0',
  ...
  { 
    file_reference: 'https://dl.dropboxusercontent.com/s/dpilucamas3r96q/warrior_3.png?dl=0',
  ...
  { 
    ...
    translation: [ 'pārśva = side', 'koṇa = angle' ],
    category: 'Standing / Lateral Bend',
    difficulty: 'Intermediate',
    description:
     [ 'From ',
  ...
  //   translation: [ 'pārśva = side', 'vīrabhadra = warrior' ],
  //   category: 'Standing / Lateral Bend',
  //   difficulty: 'Intermediate',
  //   description:
  //    [ 'From ',
  ...
  // { 
    file_reference: 'https://dl.dropboxusercontent.com/s/vyaa6kdcm8pug3j/classical_lunge.png?dl=0',
  ...
  { 
    ...
    translation: [ 'ūrdhva = upward', 'dhanu = bow' ],
    alt_name: 'Upward Bow',
    category:  'Arm+Leg Support / Backbend',
    difficulty: 'Expert',
  ...
  //   translation: [ 'camatkāra = struck with wonder' ],
  //   category: 'Arm+Leg Support / Backbend',
  //   difficulty: 'Intermediate',
  //   description:
  //    [ 'From ',
...
router.get('/', (req, res) => {
	Asana.create(asanas, function(err) {
		if (err) {
			console.log(err);
